...
function 更新皇宫背景图的程序(){
   if(主角.当前时辰 == 0){
      if(季 == 1){
         id('皇宫背景').src = 'asgPic_DCWindow/1.webp';
		 id('皇宫背景2').src = 'asgPic_DCWindow/1.webp';
      }
      else if(季 == 2){
         id('皇宫背景').src = 'asgPic_DCWindow/5.webp';
		 id('皇宫背景2').src = 'asgPic_DCWindow/5.webp';
      }
      else if(季 == 3){
        id('皇宫背景').src = 'asgPic_DCWindow/9.webp';
		id('皇宫背景2').src = 'asgPic_DCWindow/9.webp';
      }
      else if(季 == 4){
         id('皇宫背景').src = 'asgPic_DCWindow/13.webp';
		 id('皇宫背景2').src = 'asgPic_DCWindow/13.webp';
      }
   }
   else if(主角.当前时辰 == 1){
      if(季节 == "春"){
         id('皇宫背景').src = 'asgPic_DCWindow/2.webp';
      }
      else if(季节 == "夏"){
         id('皇宫背景').src = 'asgPic_DCWindow/6.webp';
      }
      else if(季节 == "秋"){
         id('皇宫背景').src = 'asgPic_DCWindow/10.webp';
      }
      else if(季节 == "冬"){
         id('皇宫背景').src = 'asgPic_DCWindow/14.webp';
      }
   }
   else if(主角.当前时辰 == 2){
      if(季节 == "春"){
         id('皇宫背景').src = 'asgPic_DCWindow/3.webp';
      }
      else if(季节 == "夏"){
         id('皇宫背景').src = 'asgPic_DCWindow/7.webp';
      }
      else if(季节 == "秋"){
         id('皇宫背景').src = 'asgPic_DCWindow/11.webp';
      }
      else if(季节 == "冬"){
        id('皇宫背景').src = 'asgPic_DCWindow/15.webp';
      }
   }
   else if(主角.当前时辰 == 3){
      if(季节 == "春"){
         id('皇宫背景').src = 'asgPic_DCWindow/4.webp';
      }
      else if(季节 == "夏"){
         id('皇宫背景').src = 'asgPic_DCWindow/8.webp';
      }
      else if(季节 == "秋"){
         id('皇宫背景').src = 'asgPic_DCWindow/12.webp';
      }
      else if(季节 == "冬"){
         id('皇宫背景').src = 'asgPic_DCWindow/16.webp';
      }
	  更新时辰的执行程序();
   }
}
